...
class AnimateBitmapSymbolTest extends Test
{
	...
	public function testBitmapSharedByHardwareAndSoftwareShapesStaysReadable():Void
	{
		...
		hardwareShapeSymbol.__setCompactCommands([
			0, bitmapSymbol.id, null, true, true,
			8, 0, 0,
			7, 640, 0,
			7, 640, 640,
			7, 0, 640,
		...
		softwareShapeSymbol.__setCompactCommands([
			0, bitmapSymbol.id, null, true, true,
			2, 0, [0x000000, 0xFFFFFF], [1.0, 1.0], [0, 255], null, 0, 0, 0,
			5
		]);
